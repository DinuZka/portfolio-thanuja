...
export default function Contact() {
  ...
  return (
    <section className="section flex flex-col min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 flex-grow flex flex-col justify-between">
        ...
        <div className="space-y-4 sm:space-y-6">
          ...
          <button className="glass-card px-8 sm:px-10 md:px-12 py-3 sm:py-3.5 md:py-4 rounded-full text-xs sm:text-sm md:text-base uppercase tracking-wider transition-all duration-300 font-medium active:scale-95 shadow-lg hover:shadow-xl">
            HIRE ME
          </button>
        </div>
        ...
        <div className="flex-grow flex items-center justify-start my-8 sm:my-12 lg:my-16">
          <h2 className="text-8xl sm:text-6xl md:text-9xl lg:text-[12rem] xl:text-[12rem] font-bold tracking-tight text-left leading-none">
            SAY HELLO!
          </h2>
        </div>
