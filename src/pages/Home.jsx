    ...
    <section className="section">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 md:py-12">
        ...
        <div className="flex justify-center mb-6 sm:mb-8 md:mb-12">
          <div className="glass-card flex items-center gap-2 sm:gap-3 md:gap-4 rounded-full px-4 sm:px-6 md:px-8 py-3 md:py-4 border transition-all duration-300">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-8 sm:gap-10 lg:gap-12 xl:gap-16 max-w-7xl mx-auto">
          {/* Text Content */}
          <div className="flex-1 w-full text-center lg:text-left space-y-4 sm:space-y-5 md:space-y-6 px-2 sm:px-0">
